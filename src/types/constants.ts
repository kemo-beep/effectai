...
// Style preset configurations - Professional color schemes inspired by top motion graphics studios
export const STYLE_CONFIGS = {
  "neon-futuristic": {
    colors: { primary: "#00ff88", secondary: "#00d4ff", background: "#0a0a0a", text: "#ffffff" },
    fontWeight: "700",
    glowEffect: true,
    description: "Cyberpunk aesthetic with electric greens and blues, perfect for tech and gaming content"
  },
  "corporate-minimal": {
    colors: { primary: "#1e40af", secondary: "#64748b", background: "#ffffff", text: "#1e293b" },
    fontWeight: "500",
    glowEffect: false,
    description: "Clean, professional palette for business presentations and corporate communications"
  },
  "hand-drawn": {
    colors: { primary: "#ea580c", secondary: "#f59e0b", background: "#fef3c7", text: "#9a3412" },
    fontWeight: "600",
    glowEffect: false,
    description: "Warm, organic colors that evoke creativity and approachability"
  },
  "kinetic-3d": {
    colors: { primary: "#7c3aed", secondary: "#db2777", background: "#0f0a19", text: "#ffffff" },
    fontWeight: "800",
    glowEffect: true,
    description: "Deep purples and magentas for immersive, dimensional experiences"
  },
  "lofi-anime": {
    colors: { primary: "#f472b6", secondary: "#a78bfa", background: "#1e1b4b", text: "#e0e7ff" },
    fontWeight: "500",
    glowEffect: false,
    description: "Soft pastels and dreamy blues for nostalgic, youthful content"
  },
  "gradient-flow": {
    colors: { primary: "#0891b2", secondary: "#7c3aed", background: "#0c0a09", text: "#ffffff" },
    fontWeight: "600",
    glowEffect: true,
    description: "Flowing gradients from cyan to purple, ideal for data visualization and tech demos"
  },
  "bold-modern": {
    colors: { primary: "#4f46e5", secondary: "#e11d48", background: "#0f0f23", text: "#ffffff" },
    fontWeight: "700",
    glowEffect: false,
    description: "High-contrast indigo and crimson for bold, contemporary designs"
  },
  "elegant-classic": {
    colors: { primary: "#92400e", secondary: "#a16207", background: "#fef7ed", text: "#5b2c06" },
    fontWeight: "400",
    glowEffect: false,
    description: "Timeless amber and gold tones for sophisticated, premium content"
  },
  // New professional styles inspired by top studios
  "vox-signature": {
    colors: { primary: "#ef4444", secondary: "#f97316", background: "#000000", text: "#ffffff" },
    fontWeight: "900",
    glowEffect: true,
    description: "Vox-inspired red-orange palette with high energy and journalistic authority"
  },
  "john-harris-premium": {
    colors: { primary: "#06b6d4", secondary: "#3b82f6", background: "#0f172a", text: "#f1f5f9" },
    fontWeight: "600",
    glowEffect: true,
    description: "Clean blues and cyans for educational content with professional credibility"
  },
  "magnates-luxury": {
    colors: { primary: "#fbbf24", secondary: "#f59e0b", background: "#1c1917", text: "#ffffff" },
    fontWeight: "700",
    glowEffect: true,
    description: "Gold and amber luxury palette for high-end branding and premium products"
  },
  "studio-drama": {
    colors: { primary: "#7c2d12", secondary: "#dc2626", background: "#000000", text: "#ffffff" },
    fontWeight: "800",
    glowEffect: true,
    description: "Deep reds and maroons for cinematic, dramatic storytelling"
  },
  "tech-minimalist": {
    colors: { primary: "#374151", secondary: "#6b7280", background: "#f9fafb", text: "#111827" },
    fontWeight: "500",
    glowEffect: false,
    description: "Subtle grays and clean whites for understated, sophisticated tech content"
  },
  "creative-vibrant": {
    colors: { primary: "#7c3aed", secondary: "#ec4899", background: "#1e1b4b", text: "#ffffff" },
    fontWeight: "700",
    glowEffect: true,
    description: "Electric purple and pink for creative, energetic, and youthful brands"
  },
};
...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    category: "educational",
    description: "Professional presentation with animated charts and statistics",
    duration: 20,
    style: "corporate-minimal",
    colors: { primary: "#2563eb", secondary: "#64748b", background: "#ffffff", text: "#1e293b" },
    customizable: ["data", "title", "colors"],
    scenes: [
      ...
      },
      {
        id: "scene-4",
        type: "infographic-chart",
        text: "North:40|South:30|East:20|West:10",
        duration: 120,
        style: "corporate-minimal",
        colors: { primary: "#2563eb", secondary: "#64748b", background: "#ffffff", text: "#1e293b" },
        animation: { easing: "spring", intensity: 0.8 },
  ...
  },
  {
    ...
    category: "promotional",
    description: "Comprehensive market analysis with pie charts and trends",
    duration: 25,
    style: "gradient-flow",
    colors: { primary: "#06b6d4", secondary: "#8b5cf6", background: "#0c0a09", text: "#ffffff" },
    customizable: ["market-data", "title", "colors"],
    scenes: [
      {
        id: "scene-1",
        type: "kinetic-typography",
      ...
      },
      {
        id: "scene-2",
        type: "infographic-chart",
        text: "Technology:35|Healthcare:25|Finance:20|Retail:15|Other:5",
        duration: 150,
        style: "gradient-flow",
        colors: { primary: "#06b6d4", secondary: "#8b5cf6", background: "#0c0a09", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.8 },
      ...
      },
      {
        id: "scene-4",
        type: "infographic-chart",
        text: "2020:10|2021:25|2022:45|2023:70|2024:95",
        duration: 150,
        style: "gradient-flow",
        colors: { primary: "#06b6d4", secondary: "#8b5cf6", background: "#0c0a09", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.8 },
  ...
  {
    id: "global-expansion-map",
    name: "Global Expansion Map",
    category: "promotional",
    description: "Animated world map showing company expansion",
    duration: 18,
    style: "neon-futuristic",
    colors: { primary: "#00ff88", secondary: "#00d4ff", background: "#0a0a0a", text: "#ffffff" },
    customizable: ["countries", "title", "colors"],
    scenes: [
      {
        id: "scene-1",
        type: "text-reveal",
      ...
      },
      {
        id: "scene-2",
        type: "infographic-chart",
        text: "Highlighted:USA|Canada|Mexico|Brazil|UK|Germany|France|Japan|Australia|India",
        duration: 180,
        style: "neon-futuristic",
        colors: { primary: "#00ff88", secondary: "#00d4ff", background: "#0a0a0a", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.9 },
  ...
  },
  {
    ...
    category: "product-demo",
    description: "Interactive dashboard showcasing product performance metrics",
    duration: 22,
    style: "kinetic-3d",
    colors: { primary: "#8b5cf6", secondary: "#d946ef", background: "#18181b", text: "#ffffff" },
    customizable: ["metrics", "product-name", "colors"],
    scenes: [
      {
        id: "scene-1",
        type: "product-showcase",
      ...
      },
      {
        id: "scene-2",
        type: "infographic-chart",
        text: "Users:85000|Revenue:$2.3M|Conversion:12%|Retention:85%",
        duration: 150,
        style: "kinetic-3d",
        colors: { primary: "#8b5cf6", secondary: "#d946ef", background: "#18181b", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.8 },
      ...
      },
      {
        id: "scene-4",
        type: "infographic-chart",
        text: "Mobile:60|Desktop:30|Tablet:10",
        duration: 120,
        style: "kinetic-3d",
        colors: { primary: "#8b5cf6", secondary: "#d946ef", background: "#18181b", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.8 },
  ...
  },
  {
    ...
    category: "educational",
    description: "Professional financial report with charts and KPIs",
    duration: 24,
    style: "elegant-classic",
    colors: { primary: "#b45309", secondary: "#a16207", background: "#fffbeb", text: "#451a03" },
    customizable: ["financial-data", "quarter", "colors"],
    scenes: [
      {
        id: "scene-1",
        type: "text-reveal",
      ...
      },
      {
        id: "scene-2",
        type: "infographic-chart",
        text: "Revenue:$2.5M|Expenses:$1.8M|Profit:$700K|Growth:15%",
        duration: 150,
        style: "elegant-classic",
        colors: { primary: "#b45309", secondary: "#a16207", background: "#fffbeb", text: "#451a03" },
        animation: { easing: "spring", intensity: 0.8 },
      ...
      },
      {
        id: "scene-4",
        type: "infographic-chart",
        text: "Jan:20|Feb:25|Mar:30|Apr:35|May:28|Jun:42",
        duration: 150,
        style: "elegant-classic",
        colors: { primary: "#b45309", secondary: "#a16207", background: "#fffbeb", text: "#451a03" },
        animation: { easing: "spring", intensity: 0.8 },
  ...
  },
  {
    ...
    category: "product-demo",
    description: "Modern tech stack presentation with animated elements",
    duration: 20,
    style: "neon-futuristic",
    colors: { primary: "#00ff88", secondary: "#00d4ff", background: "#0a0a0a", text: "#ffffff" },
    customizable: ["technologies", "title", "colors"],
    scenes: [
      {
        id: "scene-1",
        type: "kinetic-typography",
      ...
      },
      {
        id: "scene-2",
        type: "infographic-chart",
        text: "React:40|Node.js:25|Python:15|AWS:10|MongoDB:10",
        duration: 150,
        style: "neon-futuristic",
        colors: { primary: "#00ff88", secondary: "#00d4ff", background: "#0a0a0a", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.8 },
      },
      {
        id: "scene-3",
        type: "typewriter",
        text: "npm install --save react nextjs tailwindcss",
        duration: 120,
        style: "neon-futuristic",
        colors: { primary: "#00ff88", secondary: "#00d4ff", background: "#0a0a0a", text: "#ffffff" },
        animation: { easing: "spring", intensity: 0.7 },
